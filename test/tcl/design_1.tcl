...
proc create_root_design { parentCell } {
  ...
  set data_tlast [ create_bd_port -dir I data_tlast ]
  ...
  set data_out_tready [ create_bd_port -dir I data_out_tready ]
  set data_out_tlast [ create_bd_port -dir O data_out_tlast ]
  ...
  [get_bd_ports data_ready]
  connect_bd_net -net clk_1  [get_bd_ports clk] \
  [get_bd_pins axis_data_fifo_0/s_axis_aclk] \
  [get_bd_pins xfft_0/aclk]
  connect_bd_net -net data_in_1  [get_bd_ports data_in] \
  [get_bd_pins axis_data_fifo_0/s_axis_tdata]
  connect_bd_net -net data_out_tready_1  [get_bd_ports data_out_tready] \
  [get_bd_pins xfft_0/m_axis_data_tready]
  connect_bd_net -net data_tlast_1  [get_bd_ports data_tlast] \
  [get_bd_pins axis_data_fifo_0/s_axis_tlast]
  connect_bd_net -net data_valid_1  [get_bd_ports data_valid] \
